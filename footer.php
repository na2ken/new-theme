      ...
      <a class="btn" href="#pageTop"><i class="fa fa-chevron-up"></i></a>
       ...
       <div class="l-footerAbove">
             <div class="container">
                ...
                <div class="menu"><ul><li class="page_item page-item-11"><a href="http://bp-media.iaowd.com/blog/">blog</a></li><li class="page_item page-item-7"><a href="http://bp-media.iaowd.com/contact/">お問い合わせ</a></li><li class="page_item page-item-10 current_page_item"><a href="http://bp-media.iaowd.com/">フロントページ</a></li></ul></div>
                           </div>
                       </div>
                       <div class="col-md-4">
