...
<?php $args = array(
    ...
    'comment_field' => '<div class="control-group form-group col-sm-12 floating-label-form-group controls">' . '<textarea class="comment form-control input-lg" name="comment" cols="50" rows="6" aria-required="true"' . $aria_req . ' placeholder="コメントをください" /></textarea></div>',
    );
comment_form( $args ); ?>
</div>
